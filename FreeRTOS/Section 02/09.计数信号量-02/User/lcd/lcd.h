...
//宏：引脚定义
#define LCD_LED(_BIT_) HAL_GPIO_WritePin(GPIOB, GPIO_PIN_15, (_BIT_) ? (GPIO_PIN_SET) : (GPIO_PIN_RESET))
//宏：FSMC地址
...
void LCD_SetPenColor(uint32_t pen, uint32_t back);
_lcd_dev LCD_GetDev(void);
#endif
